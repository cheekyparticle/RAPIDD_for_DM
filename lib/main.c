...
int main() {
  ...
  //define_and_write_halo(struct_halo.profile, struct_halo.vesc, struct_halo.v0, struct_halo.beta,
  //                      0.0, struct_halo.v0_lsr, ve, struct_halo.k, struct_halo.i);

  /* Time-dependent (modulated) call */
  //define_and_write_halo_time(struct_halo.profile, struct_halo.vesc, struct_halo.v0, struct_halo.beta,
  //                            struct_halo.v0_lsr, struct_halo.v_pec,
  //                            struct_halo.k, struct_halo.i, struct_halo.t0, struct_halo.T);


  // #######################################################################
  // Calculate differential rates and write to file
  // #######################################################################
